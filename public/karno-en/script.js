...
class KarnoMap {
    ...
    generateKarno4Var(container) {
        console.log('Generating 4-variable Karno map - Grid intersection design');
        ...
        // 4 variable Gray code: AB\CD: 00, 01, 11, 10
        const order = [
    ...
    renderKarnoMap() {
        ...
        if (cells.length === 0) {
            console.error('Karno cells not found! generateKarnoMap may not have run.');
            return;
        }
