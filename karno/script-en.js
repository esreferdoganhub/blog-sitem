...
class KarnoMap {
    constructor() {
        ...
        this.isLocked = false; // Gruplar oluşturulduktan sonra kilitleme durumu
        this.hasGroups = false; // Grup varlığını takip etme
...
// KarnoMap'i global window objesine ekle
