    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] gap-10 px-4 py-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
          <a href="/uygulamalar" className="rounded-full bg-blue-600 text-white px-6 py-3 font-semibold shadow hover:bg-blue-700 transition">Uygulamalarım</a>
          <a href="/karno/karno.html" className="rounded-full bg-purple-600 text-white px-6 py-3 font-semibold shadow hover:bg-purple-700 transition">Karno Haritası</a>
          <a href="/blog" className="rounded-full bg-green-600 text-white px-6 py-3 font-semibold shadow hover:bg-green-700 transition">Blog</a>
        </div>
        
        {/* Basit Gazze/Doğu Türkistan Hatırlatması */}
        <div className="mt-12 bg-gray-100 p-6 rounded-lg shadow max-w-xl mx-auto">
          <Image src="/gtrdt.jpg" alt="Gazze ve Doğu Türkistan" width={600} height={256} className="w-full max-h-64 object-contain rounded-lg mb-4" />
